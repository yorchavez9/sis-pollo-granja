...
foreach ($tickets as $ticket) {
    ...
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->MultiCell(0, 5, iconv("UTF-8", "ISO-8859-1", strtoupper("Factura N°: " . $respuesta["serie_prefijo"] .'-'. $respuesta["num_comprobante"] ."")), 0, 'C', false);
    $pdf->SetFont('Arial', '', 9);
...
if (isset($_GET['accion']) && $_GET['accion'] === 'descargar') {
    // Descargar el PDF
    $pdf->Output('D', 'factura' . $numero_comprobante . '_v.pdf'); // 'D' fuerza la descarga con el nombre 'boleta.pdf'
} else {
