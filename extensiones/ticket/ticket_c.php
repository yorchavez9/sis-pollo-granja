...
foreach ($tickets as $ticket) {
    ...
    foreach ($respuesta_de as $value) {
        ...
        $pdf->Cell(14, 4, iconv("UTF-8", "ISO-8859-1", "USD " . formatearPrecio($value["precio_venta"]) . ""), 0, 0, 'C');
    ...
    $pdf->Cell(32, 5, iconv("UTF-8", "ISO-8859-1", "USD " . formatearPrecio($respuesta["igv_total"]) . ""), 0, 0, 'R');
    ...
    $pdf->Cell(32, 5, iconv("UTF-8", "ISO-8859-1", "USD " . formatearPrecio($respuesta["total_cotizacion"]) . ""), 0, 0, 'R');
