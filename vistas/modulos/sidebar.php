...
$permisosMenu = [
    'sucursales' => ['DUEÑO', 'ADMINISTRADOR'],
    'personas' => ['ADMINISTRADOR'],
    'inventario' => ['TRABAJADOR', 'AYUDANTE'],
    'trabajadores' => ['DUEÑO'],
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <?php if (tieneRol($permisosMenu['sucursales'])): ?>
                    <li>
                        <a href="sucursales"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
