            ...
            <div class="card-body">
                ...
                <div class="table-top">
                    ...
                    <div class="wordset">
                        <ul>
                            <li>
                                <a data-bs-toggle="tooltip" id="btn_descargar_reporte_cliente" data-bs-placement="top" title="pdf"><img src="vistas/assets/img/icons/pdf.svg" alt="img"></a>
                            </li>
                            <li>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" style="width:100%" id="tabla_reporte_cliente">
                        <thead>
                            <tr>
                                <th>Foto</th>
                                <th>Proveedor</th>
