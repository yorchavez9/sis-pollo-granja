<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn" id="btn_agregar_configuracion_correo">
...
=================================================== -->
<div class="modal fade" id="modal_nuevo_configuracion_correo" tabindex="-1" aria-labelledby="modal_nuevo_configuracion_correo_Label" aria-hidden="true">
...
=================================================== -->
<div class="modal fade" id="modal_editar_correo_config" tabindex="-1" aria-labelledby="modal_editar_correo_config_label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Configurar</h5>
            ...
            <form enctype="multipart/form-data" id="form_udpate_correo_config">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" id="id_config_correo_edit">
                    </div>

                    <!-- INGRESO ID DEL USUARIO -->
                    <div class="form-group">
                        <input type="hidden" id="id_usuario_config_correo_edit" value="<?php echo $_SESSION["id_usuario"] ?>">
                    </div>
                ...
                <div class="text-end mx-4 mb-2">
                    <button type="button" id="btn_update_correo_config" class="btn btn-primary mx-2">
