            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" id="filtro_precio_min" min="0" class="form-control" placeholder="S/">
                    </div>

                    <div class="col-md-2">
                        <label for="filtro_precio_max" class="form-label">Precio Máximo</label>
                        <input type="number" id="filtro_precio_max" min="0" class="form-control" placeholder="S/">
                    </div>
