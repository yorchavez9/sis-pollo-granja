                    ...
                    <div class="col-md-12">
                        ...
                        <form id="form_contizacion_venta">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="number" id="validez_contizacion" class="form-control me-2" name="validez_contizacion" value="1" min="0">
                                            <p class="mb-0">Días.</p>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="text" id="igv_venta" name="igv_venta" value="0" min="0" class="form-control me-3" style="width: 120px;">
                            ...
                            <div class="text-center mb-5">
                                <a href="#" class="btn btn-primary btn-add-category" data-bs-toggle="modal" data-bs-target="#modal_agregar_producto_cotizacion">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="pt-3 pb-2">
                                        ...
                                        <!-- SECCIÓN DE PRECIO DE VENTA BOLIVARES -->
...
<div class="modal fade" id="modal_agregar_producto_cotizacion" tabindex="-1" aria-labelledby="modal_agregar_producto_cotizacionLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered" style="width:100%" id="tabla_add_producto_cotizacion">
                            <thead>
                                <tr>
