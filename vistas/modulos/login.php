...
?>
    ...
    <div class="main-wrapper" style="min-height: 100vh; display: flex; justify-content: center; align-items: center; background-image: url('<?php echo ($value["img_login"] != '' && $value["img_login"] != null) ? substr($value["img_login"], 3) : 'vistas/img/sistema/login3.jpeg'; ?>'); background-size: cover; background-position: center; position: relative;">
            ...
            <div class="login-content">
                <div class="login-userset">
                    ...
                    <div class="login-userheading text-center mb-4">
                        <img src="<?php echo ($value["icon_login"] != '' && $value["icon_login"] != null) ? substr($value["icon_login"], 3) : 'vistas/img/sistema/login-logo.png'; ?>" width="100" alt="">
